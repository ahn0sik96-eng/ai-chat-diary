...
/**
 * Lightweight, offline "AI" that plays the role of a warm journaling
 * companion. It picks an empathetic, open-ended follow-up based on simple
 * keyword cues. No network / API key required — purely for the UI demo.
 */
...
/** Generate the assistant's next reply given the latest user message. */
...
/** Naive mood inference from the whole conversation. */
...
/** Distill a short diary summary + title from the conversation. */
